 ...
 README for local_kuenrol plugin
 ...
 GENERAL INFORMATION
 -------------------
 local_kuenrol is a Moodle plugin used to import enrollments and group
 ...
 INSTALLATION
 ------------
 Place the kuenrol directory in the site's local directory. Access the
